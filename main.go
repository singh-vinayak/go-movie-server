...
import (
	...
	"github.com/singh-vinayak/go-movie-server/tree/postgres-with-gorm/storage"
	"github.com/singh-vinayak/go-movie-server/tree/postgres-with-gorm/models"
	"gorm.io/gorm"
)
...
func (r *Repository) GetBookByID(context *fiber.Ctx) error {
	...
	if err != nil {
		context.Status(http.StatusBadRequest).JSON(&fiber.Map{
			"message":"cannot find book by id",
		})
		return err
	}
